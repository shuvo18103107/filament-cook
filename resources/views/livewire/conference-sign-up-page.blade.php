        ...
        <div class="py-24 sm:py-32 lg:pb-40">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <h1 class="text-balance text-5xl font-semibold tracking-tight text-white sm:text-7xl">Laracon Dhaka
                    </h1>
                    <p class="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">Sign in to your account
                        to
                        manage your conference tickets and access exclusive content.</p>
                    </p>
